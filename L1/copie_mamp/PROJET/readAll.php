    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="./readAll.php" class="nav-link px-2 text-secondary">
                        <h1 class="ml11">
                            <span class="text-wrapper">
                                <span class="line line1"></span>
                                <span class="letters">Tous les articles</span>
                            </span>
                        </h1>
                    </a></li>
    ...
    <div class="d-flex flex-wrap justify-content-center">
        ...
        ?>
            <div class="card m-5" style="width: 15rem;">
                <img src="<?= $article->getLien_image(); ?>" class="card-img-top" alt="problème d'affichage d'image">
                <div class="card-body">
